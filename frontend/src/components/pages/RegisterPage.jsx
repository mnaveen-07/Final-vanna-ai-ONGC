    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 13, color: "rgba(255,255,255,0.7)" }}>Create your account</p>
        </div>

        {/* Fields */}
        <div style={{ marginBottom: 16 }}>
          <label style={{ fontSize: 12, color: "rgba(255,255,255,0.7)", display: "block", marginBottom: 4 }}>FULL NAME</label>
          <input
            type="text"
