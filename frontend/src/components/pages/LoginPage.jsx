  ...
  return (
    <div style={{ 
      ...
      >
        ...
        <div style={{ flex: 1, padding: "64px 48px", display: "flex", flexDirection: "column", justifyContent: "center", background: "var(--bg-surface)" }}>
          <div style={{ width: "100%", maxWidth: 360, margin: "0 auto" }}>
            <div style={{ marginBottom: 40 }}>
              <Brain size={28} color="var(--accent)" style={{ marginBottom: 16 }} />
              <h2 style={{ fontSize: 28, fontWeight: 700, color: "var(--text-primary)", marginBottom: 8, letterSpacing: "-0.02em" }}>Welcome back</h2>
            ...
            <div style={{ marginTop: 32, textAlign: "center", fontSize: 14 }}>
              ...
              <Link to="/register" style={{ color: "var(--info)", textDecoration: "none", fontWeight: 600 }}>
                Sign up
              </Link>
            </div>
          </div>
